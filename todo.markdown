...
- [x] ~~List of all the chords (ideally with finger diagrams)~~
- [x] ~~List of our songs... the 9-string ones, and try to get the sheet music large kankles songs, too~~
- [ ] Try and get the scanned music from the old big folder in, and also the music notes from the little books
- [x] ~~Maybe see if we can show the chords on the 9 string songs so it's easy to reference~~
- [x] ~~download the sheet music~~
